    ...
    private void checkState(){
          ...
          if (frog.getTranslateY() <= 0){
              ...
              for (int i = 0; i<win.toCharArray().length ; i++){
                  ...
                  ft.setToValue(1);
                  ft.setDuration(Duration.seconds(i * 0.15));
                  ft.play();
              }
          }
    }
    ...
    public void start(Stage stage) throws Exception{
        ...
        stage.getScene().setOnKeyPressed(event -> {
            switch (event.getCode()){
                ...
                case S: if (frog.getTranslateY() < 600 - 39){
                    frog.setTranslateY(frog.getTranslateY() + 40);
                }else {
                    frog.setTranslateY(600 - 39);
                }
                ...
                case A: if (frog.getTranslateX() > 0 ){
                ...
                case D: if (frog.getTranslateX() < 760){
                    System.out.println(frog.getTranslateX());
                    frog.setTranslateX(frog.getTranslateX() + 40);
                }else {
                    frog.setTranslateX(800 - 40);
                }
